    <!-- Begin Nav
================================================== -->
    <nav class="navbar navbar-toggleable-md navbar-light bg-custom mediumnavigation">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <form class="form-inline my-2 my-lg-0" action="#" method="get">
                    <input class="form-control mr-sm-2" type="text" name="cari" placeholder="Search" disabled>
